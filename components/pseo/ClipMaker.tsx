...
const ICONS = ["lucide:clapperboard", "lucide:sparkles", "lucide:share-2"];

export default function ClipMaker({ data }: { data: KeywordRow }) {
  return (
    <PseoLayout data={data}>
      <section className="pseo-hero">
        ...
        <div className="pseo-tool-embed">
          <ClipTool defaultAction={data.primaryAction || "clip"} />
        </div>
      </section>
      ...
      <section className="pseo-faq-section">
        ...
        <h2 className="pseo-section-title">Capture the perfect moment</h2>
