...
const ICONS = ["lucide:crop", "lucide:shield-check", "lucide:monitor-smartphone"];

export default function CropOnline({ data }: { data: KeywordRow }) {
  return (
    <PseoLayout data={data}>
      <section className="pseo-hero">
        ...
        <div className="pseo-tool-embed">
          <ClipTool defaultAction={data.primaryAction || "crop"} />
        </div>
      </section>
      ...
      <section className="pseo-faq-section">
        ...
        <h2 className="pseo-section-title">Everything you need to crop your video</h2>
